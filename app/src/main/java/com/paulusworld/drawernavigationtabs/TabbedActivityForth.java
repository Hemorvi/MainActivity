 ...
 */
public class TabbedActivityForth extends Fragment {
    ...
    public static final String TAG = TabbedActivityForth.class.getSimpleName();
    ...
    public static TabbedActivityForth newInstance() {
        return new TabbedActivityForth();
    }
