 ...
 */
public class TabbedActivitySecond extends Fragment {
    ...
    public static final String TAG = TabbedActivitySecond.class.getSimpleName();
    ...
    public static TabbedActivitySecond newInstance() {
        return new TabbedActivitySecond();
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position) {
                ...
                case 1:
                    return new SpurthyProfileFragment();
                case 2:
