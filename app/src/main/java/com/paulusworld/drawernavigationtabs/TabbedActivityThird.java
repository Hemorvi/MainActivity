 ...
 */
public class TabbedActivityThird extends Fragment {
    ...
    public static final String TAG = TabbedActivityThird.class.getSimpleName();
    ...
    public static TabbedActivityThird newInstance() {
        return new TabbedActivityThird();
    }
